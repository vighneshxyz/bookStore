...
function Baaner() {
  return (
    ...
    <div className='max-w-screen-2xl container mx-auto md:px-20 px-4 flex flex-col md:flex-row my-10'>
        ...
        Sit dolor omnis facere dicta repudiandae magni quo totam, excepturi ducimus dignissimos 
        eos voluptates vel doloremque ad accusantium suscipit consectetur quasi vitae?</p>
  ...
  <input type="text" className="grow" placeholder="Email" />
        ...
        <img  className="w-92 h-92" src={backdrop} alt="" />
        </div>
    </div>
    </>
  )
